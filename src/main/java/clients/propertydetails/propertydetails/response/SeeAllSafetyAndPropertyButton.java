...
public class SeeAllSafetyAndPropertyButton {
    ...
    @Expose
    private LoggingEventData__7 loggingEventData;
    ...
    public LoggingEventData__7 getLoggingEventData() {
        return loggingEventData;
    }

    public void setLoggingEventData(LoggingEventData__7 loggingEventData) {
