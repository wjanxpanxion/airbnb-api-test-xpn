...
public class SeeAllHouseRulesButton {
    ...
    @Expose
    private LoggingEventData__4 loggingEventData;
    ...
    public LoggingEventData__4 getLoggingEventData() {
        return loggingEventData;
    }

    public void setLoggingEventData(LoggingEventData__4 loggingEventData) {
