...
public class SeeDetailsLink {
    ...
    @Expose
    private LoggingEventData__3 loggingEventData;
    ...
    public LoggingEventData__3 getLoggingEventData() {
        return loggingEventData;
    }

    public void setLoggingEventData(LoggingEventData__3 loggingEventData) {
