...
public class LearnMoreButton__1 {
    ...
    @Expose
    private LoggingEventData__8 loggingEventData;
    ...
    public LoggingEventData__8 getLoggingEventData() {
        return loggingEventData;
    }

    public void setLoggingEventData(LoggingEventData__8 loggingEventData) {
