...
public class ReadMoreButton {
    ...
    @Expose
    private LoggingEventData__2 loggingEventData;
    ...
    public LoggingEventData__2 getLoggingEventData() {
        return loggingEventData;
    }

    public void setLoggingEventData(LoggingEventData__2 loggingEventData) {
