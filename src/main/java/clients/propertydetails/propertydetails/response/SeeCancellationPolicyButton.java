...
public class SeeCancellationPolicyButton {
    ...
    @Expose
    private LoggingEventData__5 loggingEventData;
    ...
    public LoggingEventData__5 getLoggingEventData() {
        return loggingEventData;
    }

    public void setLoggingEventData(LoggingEventData__5 loggingEventData) {
