...
public class LearnMoreButton {
    ...
    @Expose
    private LoggingEventData__6 loggingEventData;
    ...
    public LoggingEventData__6 getLoggingEventData() {
        return loggingEventData;
    }

    public void setLoggingEventData(LoggingEventData__6 loggingEventData) {
